...
# Must lag! Didn't do that yet

tables  <- tables %>% na.omit %>% as.data.frame
tables  <- cbind(tables[2:dim(tables)[1], 83], tables[1:(dim(tables)[1]-1), -83]) # dplyr was not lagging correctly so I lagged by hand and made col 83 first col
